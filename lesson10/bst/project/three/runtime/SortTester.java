package lesson10.bst.project.three.runtime;

import java.io.BufferedReader;
import java.io.FileReader;
import java.util.Arrays;
import java.util.Stack;
import lesson10.bst.project.three.util.RandomPermutations;
import java.util.*;
...
public class SortTester {
	...
	private final String PACKAGE = "lesson10.bst.project.three.sortroutines";
	...
	public void runTests() {
		...
		while (!sorters.isEmpty()) {
			...
			String name = lesson10.bst.project.three.util.Util.getClassNameNoPackage(nextSorter.getClass());
