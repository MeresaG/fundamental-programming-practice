package lesson10.bst.project.one.bst;
...
import lesson10.bst.project.one.employeebst.Employee;
import lesson10.bst.project.one.employeebst.NameComparator;

public class EmployeeBST {
	/** The tree root. */
	private Node root;
	private Comparator<Employee> nc;
	...
	public EmployeeBST(Comparator<Employee> nc) {
	...
	public static void main(String[] args) {
		/*
		 * EmployeeBST bst = new EmployeeBST(); for (int i = 15; i >= 0; --i) {
		 * bst.insert(new Integer(2 * i)); bst.insert(new Integer(2 * i - 5)); }
		 * bst.printTree(); System.out.println("Is 24 in the tree? " + bst.find(new
		 * Integer(24))); System.out.println("Is 27 in the tree? " + bst.find(new
		 * Integer(27)));
		 */
